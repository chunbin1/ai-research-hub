...
cd /Users/lee/myCode/ai-research-hub
git add packages/server/src/services/signals/probeSymbol.ts packages/server/src/services/signals/probeSymbol.test.ts packages/server/src/services/market/yahooClient.ts packages/server/src/services/market/yahooClient.test.ts
